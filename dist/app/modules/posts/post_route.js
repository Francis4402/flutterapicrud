...
router.post('/', multer_config_1.multerUpload.fields([{ name: 'images' }]), bodyParser_1.parseBody, (0, validateRequest_1.default)(post_validation_1.postValidationShcema), post_controller_1.postController.createPost);
